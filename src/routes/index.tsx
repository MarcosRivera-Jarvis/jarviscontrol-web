  ...
  head: () => ({
    meta: [
      { title: "JARVIS Control | Automatización empresarial con IA" },
      {
        name: "description",
        content:
          "Automatización empresarial, agentes IA, gestión inteligente de correos, facturas, clientes VIP, CRM, ERP, WhatsApp, Telegram y flujos n8n.",
      },
      {
        property: "og:title",
      ...
      },
      {
        ...
        content:
          "Diseñamos automatizaciones B2B con IA para reducir trabajo manual, conectar herramientas y mejorar la operación diaria.",
      },
    ],
  }),
  component: Landing,
